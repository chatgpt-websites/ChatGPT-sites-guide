...
[**ChatGPT 中文版**](https://talk.lanjing.pro) 是 OpenAI 开发的 ChatGPT 模型的本地化中文版本，专为国内用户设计，提供流畅和精准的对话能力。
...
|--------------------|----------------------------------|------------------------------|----------|------------------|---------|-------------------------------------|
| 一下AI            | [xsimplechat.com](https://xsimplechat.com/) | GPT-4、4o、o1、o3 和 DS-R1    | 有       | 扫码即可         | 高      | 支持 AI 绘画、AI 助手、AI 插件、AI PPT 等 |
| AI智慧岛          | [talk.lanjing.pro](https://talk.lanjing.pro/)     | GPT-4o、4o mini、o1、o3 和 DS-R1 | 有       | 扫码即可         | 高      | 支持多模型，AI 写作、AI 编程、AI 工作    |
| AI工具站          | [gpt4us.org](https://gpt4us.org/chatgpt-china-site)           | GPT-4、o1                    | 有       | 扫码即可         | 高      | 稳定快速，各种 AI 工具                |
| AI指南            | [yixiaai.com](https://chat.yixiaai.com/) | GPT-4、o1                    | 有       | 扫码即可         | 高      | AI 使用指南                          |
